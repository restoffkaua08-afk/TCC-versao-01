...
const sections: Array<{ label: Section; icon: ReactNode; description: string }> = [
 ...
 { label: "Gêmeo Digital", icon: <Activity size={19} />, description: "Simulações Operacionais Operacionais Operacionais e diagnóstico" },
 ...
 { label: "Configurações", icon: <Settings size={19} />, description: "Tanque de Processo de Processo de Processos, mangueiras e receitas" },
];
...
export default function App() {
 ...
 <small>Tanque de Processo de Processo de Processos de reguladores · SV630B · WSU2001</small>
 </div>

 <div className="topbar-actions">
 <DemoBadge />
 <button type="button" className="secondary" onClick={() => refresh(true)}><RotateCcw size={17} /> Atualizar Dados Dados Dados</button>
