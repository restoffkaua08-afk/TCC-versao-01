...
export function SettingsPage({ tanks, hoses, recipes }: { tanks: Tank[]; hoses: Hose[]; recipes: Recipe[] }) {
 ...
 subtitle="Tanque de Processo de Processo de Processos, mangueiras e receitas usados pela simulação do processo TSEA."
 />

 <section className="grid">
 <AssetPanel title="Tanque de Processo de Processo de Processos cadastrados" icon={<Gauge size={18} />} rows={tanks} labels={labels.tank} />
