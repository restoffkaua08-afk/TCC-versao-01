...
export function OverviewPage({
 ...
 <span>Estado Operacional atual</span>
 ...
 <Kpi label="Índice Máximo de Risco" value={fmt(maxRisk, "%")} hint="maior risco estrutural" tone={maxRisk > 82 ? "bad" : maxRisk > 65 ? "warn" : "good"} />
 <Kpi label="Eficiência estimada" value={fmt(efficiency, "%")} hint="índice operacional" tone={efficiency > 80 ? "good" : "warn"} />
 </section>
